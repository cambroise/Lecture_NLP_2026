...
![](../images/paste-1BEDD8F0.png) *Number of words occurence in 4 Shakespeare plays (from speech and langage processing)*
...
![](../images/paste-48FC80E5.png) *word-word matrix from a Wikipedia corpus (from speech and langage processing)*
...
![](../images/paste-F81A0994.png) *A tf-idf weighted term-document matrix. Note that the tf-idf weighting has eliminated the importance of the ubiquitous word good and vastly reduced the impact of the almost-ubiquitous word fool.*
...
![](../images/paste-4E8CF1EE.png)*A PPMI matrix showing the association between words and context words*
...
![](../images/paste-02B7F08D.png)

## Skip-gram model learns two separate embeddings

![](../images/paste-14C45962.png)
